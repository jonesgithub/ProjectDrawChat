...
#import <tgmath.h>
	...
	#define MB_TEXTSIZE(text, font) [text length] > 0 ? [text \
		sizeWithAttributes:@{UITextAttributeFont:font}] : CGSizeZero;
#else
	...
	#define MB_MULTILINE_TEXTSIZE(text, font, maxSize, mode) [text length] > 0 ? [text \
		...
		attributes:@{UITextAttributeFont:font} context:nil].size : CGSizeZero;
#else
	#define MB_MULTILINE_TEXTSIZE(text, font, maxSize, mode) [text length] > 0 ? [text \
...
+ (MBProgressHUD *)createAndShowInView:(UIView *)view
{
