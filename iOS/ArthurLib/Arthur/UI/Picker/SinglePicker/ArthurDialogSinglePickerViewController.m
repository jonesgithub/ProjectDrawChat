...
@implementation ArthurDialogSinglePickerViewController
...
- (void)viewDidLoad
{
    ...
    //设置选择器的位置
    CGRect screenRect = [ArthurCompatible frameOfScreen];
    self.pickerOfSingle.frame = CGRectMake(
                                         0, 
                                         screenRect.size.height - [ArthurCompatible heightOfPickerView] - [ArthurCompatible heightOfNavigationBarInController:self],
                                         320, 
                                         [ArthurCompatible heightOfPickerView]
                                         );
//    NSLogRect(self.pickerOfSingle.frame);
