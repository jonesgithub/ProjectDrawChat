...
@implementation AnimationButtonGroup
...
onButtonValuesChanged:(onButtonValuesChanged)handerButtonValuesChanged
{
    ...
    for (int i = 0; i < [arrButtonNames count]; i++) {
        CGRect rectOfButton = CGRectMake(fStartX, fStartY, fButtonWidth, fButtonHeight);
        fStartX += fButtonWidth + nSeperate;
        ArthurAnimationButton *button = [[ArthurAnimationButton alloc] initWithFrame:rectOfButton];
